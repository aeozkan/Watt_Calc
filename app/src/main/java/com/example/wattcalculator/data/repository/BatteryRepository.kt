package com.example.wattcalculator.data.repository
...
class BatteryRepository(private val context: Context) {
    ...
    private fun parseCurrentToAmperes(rawCurrent: Int, isCharging: Boolean): Double {
        ...
        // Microamperes (uA) values are typically > 10,000 (e.g. 2,500,000 uA = 2.5 A)
        // Milliamperes (mA) values are typically <= 10,000 (e.g. 2500 mA = 2.5 A)
        val amperes = when {
